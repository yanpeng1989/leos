		...
		<div class="content-wrapper">
			<section class="content-header">
				...
				<ol class="breadcrumb">
					...
					<li class="active">K币转激活币($</li>
				</ol>
			</section>
			<section class="content">
				<div class="box">
					<div class="box-header with-border">
						<h3 class="box-title">K币转激活币($</h3>
					</div>
					<div class="box-body">
                		<div class="info-box" style="height: 30px;width: 100%;">
                			<span class="info-box-icon" style="background-color:#3c8dbc;width: 100%;">
                				<label style="font-size: 14px;color: white;">我的K币($)金额:200</label>
                			</span>
              			</div>
              			<div class="info-box" style="height: 30px;width: 100%;">
                			<span class="info-box-icon" style="background-color:#3c8dbc;width: 100%;">
                				<label style="font-size: 14px;color: white;">我的激活币($)金额:100</label>
                			</span>
              			</div>
					</div>
					<br/>
					<div class="box-body">
						<div class="input-group">
							<span class="input-group-addon">兑换金额</span> 
					...
					<div class="box-body">
						<div class="input-group">
							<span class="input-group-addon">兑换备注</span> 
							<input type="text" class="form-control">
						</div>
					</div>
				<div class="box">
					<div class="box-body">
						<button class="btn btn-primary btn-block btn-flat">确认兑换</button>
					</div>
				</div>
			</div>
			</section>
